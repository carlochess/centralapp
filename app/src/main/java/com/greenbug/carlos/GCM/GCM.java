...
public class GCM {
    ...
    public void almacenarId(){
        SharedPreferences.Editor editor  = c.getSharedPreferences("centralapp", c.MODE_PRIVATE).edit();
        editor.putString("idCelular", regid);
        editor.apply();
    }
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        return context.getSharedPreferences(portal.class.getSimpleName(),
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            /*if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Log.i("GCM", "Este dispositivo no lo abarcamos.");
                //finish();
            }*/
            return false;
        }
